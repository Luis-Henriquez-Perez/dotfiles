...
- *Dotfile Management*: [[https://git-scm.com/][git]]
  ...
  I manage my dotfiles using a [[https://www.atlassian.com/git/tutorials/dotfiles][bare Git repository]].  Unlike other tools like
  [[https://yadm.io/][yadm]], [[https://www.gnu.org/software/stow/][GNU Stow]], and [[https://www.chezmoi.io/][chezmoi]], this approach requires no additional dependencies
  beyond Git, avoids symlinks, and is overall simpler to maintain.
