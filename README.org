...
Run the following command which will download the [[~/scripts/dotinit.sh][dotinit.sh]] and runs it.
The script then clones my dotfiles as a bare git repo and attempts to propagate
