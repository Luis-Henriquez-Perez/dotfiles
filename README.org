...
Run the following command which will download the [[~/scripts/dotinit.sh][dotinit.should have]] and run it.
The  clones my dotfiles as a bare git repo and attempts to propagate
