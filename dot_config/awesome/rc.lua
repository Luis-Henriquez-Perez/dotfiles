...
-- of this file choose to split the code sometimes. blah blah blah blah blah
...
global_key({ modkey }, "h", swap_with_master,      { description = "swap index with master", group = "client" })
global_key({ modkey }, "j", focus_next_client,     { description = "focus next client"     , group = "client" })
global_key({ modkey }, "k", focus_previous_client, { description = "focus previous client" , group = "client" })
global_key({ modkey }, "l", swap_with_master,      { description = "swap index with master", group = "client" })
...
global_key({ modkey, "Shift"}, "r", awesome.restart, { description = "restart awesome" , group = "awesome" })
