...
(defhook! org-insert-heading-hook&enter-insert-state ()
  ...
  (and (bound-and-true-p evil-mode)
       (evil-insert-state t)))
;;;; keybindings
;; (oo-bind evil-org-headline-state-map "y" #'org-copy-subtree)
(oo-bind org-mode-map :ie "ESC" #'evil-org-headline-state)
(oo-bind org-mode-map :ie [escape] #'evil-org-headline-state)
;; I need a way to enter this state in normal state.
(oo-bind org-mode-map :n "R" #'evil-org-headline-state)

(oo-bind evil-org-headline-state-map "w" #'widen)
(oo-bind evil-org-headline-state-map "s" #'org-insert-subheading)
(oo-bind evil-org-headline-state-map "R" #'org-refile)
(oo-bind evil-org-headline-state-map "N" #'evil-normal-state)
(oo-bind evil-org-headline-state-map "n" #'org-narrow-to-subtree)
(oo-bind evil-org-headline-state-map "x" #'org-cut-subtree)
(oo-bind evil-org-headline-state-map "j" #'oo-org-next-visible-heading)
(oo-bind evil-org-headline-state-map "k" #'oo-org-previous-visible-heading)
(oo-bind evil-org-headline-state-map "h" #'org-do-promote)
(oo-bind evil-org-headline-state-map "l" #'org-do-demote)
(oo-bind evil-org-headline-state-map "t" #'org-todo)
;; (oo-bind evil-org-headline-state-map "L" #'evilem-motion-heading)
;; TODO: use good way of making `org-up-heading-safe' interactive.
;; (oo-bind evil-org-headline-state-map "H" #'org-up-heading-safe)
(oo-bind evil-org-headline-state-map "J" #'org-move-subtree-down)
(oo-bind evil-org-headline-state-map "K" #'org-move-subtree-up)
(oo-bind evil-org-headline-state-map "<" #'org-promote)
(oo-bind evil-org-headline-state-map ">" #'org-demote)
(oo-bind evil-org-headline-state-map "TAB" #'outline-toggle-children)
(oo-bind evil-org-headline-state-map "o" #'org-insert-heading-after-current)
(oo-bind evil-org-headline-state-map "O" #'oo-org-insert-heading-before-current)
(oo-bind evil-org-headline-state-map [escape] #'evil-normal-state)
;;; provide
