...
(define-abbrev global-abbrev-table "cpature" "capture" nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
...
(define-abbrev global-abbrev-table "al"             "autoload"                      nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
