...
(define-abbrev global-abbrev-table "dnw"            "does not work"                 nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "htdw"           "has to do with"                nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "espl"           "especially"                    nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "exc"            "except"                        nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "fils"           "files"                         nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "doesnth"        "does not have"                 nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "fiels"          "files"                         nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "backw"          "backward"                      nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "forw"           "forward"                       nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "acept"          "accept"                        nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "swpawn"         "spawn"                         nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "nother"         "another"                       nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "awesoe"         "awesome"                       nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "iad"            "in addition"                   nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "rearange"       "rearrange"                     nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "bett"           "better"                        nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "theone"         "the one"                       nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "iwc"            "in which case"                 nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "ben"            "been"                          nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "praticular"     "particular"                    nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "faw"            "for a while"                   nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "highl"          "highlight"                     nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "whi"            "while"                         nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "eh"             "the"                           nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "appa"           "apparent"                      nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "yr"             "year"                          nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "xp"             "experience"                    nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "implem"         "implementation"                nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
...
(define-abbrev global-abbrev-table "teime"          "time"                          nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "wast"           "waste"                         nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "taks"           "tasks"                         nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "imple"          "implement"                     nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "impltt"         "implementation"                nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "divied"         "divided"                       nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "itme"           "item"                          nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "idkw"           "I do not know what"            nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "ambig"          "ambiguous"                     nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "hsi"            "his"                           nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "stats"          "statistics"                    nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "defalt"         "default"                       nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "inter"          "interesting"                   nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "idnt"           "I do not"                      nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "david"          "David"                         nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "workflwo"       "workflow"                      nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "amnt"           "amount"                        nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "gtd"            "GTD"                           nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "whatd"          "what would"                    nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "watd"           "what would"                    nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
...
(define-abbrev global-abbrev-table "bs"             "bullshit"                      nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "alr"            "already"                       nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "exaustion"      "exhaustion"                    nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "thare"          "that are"                      nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "cmp"            "compare"                       nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "tf"             "therefore"                     nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "dren"           "children"                      nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "aee"            "all else equal"                nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "aee"            "all else equal"                nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "keyw"           "keyword"                       nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "deln"           "deletion"                      nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "wndow"          "window"                        nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "idnht"          "I did not have to"             nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "win"            "window"                        nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "anyt"           "anything"                      nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "hls"            "headlines"                     nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "hgs"            "headings"                      nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
...
(define-abbrev global-abbrev-table "iwrh"           "I would rather have"           nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "iw"             "I would"                       nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "consisten"      "consistent"                    nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "alphz"          "alphabetize"                   nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "menti"          "mention"                       nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "creeate"        "create"                        nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "nvm"            "nevermind"                     nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "ve"             "very"                          nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "higs"           "highest"                       nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "overr"          "override"                      nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "creaed"         "created"                       nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "strat"          "strategy"                      nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "adi"            "aid"                           nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "deadlie"        "deadline"                      nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "comm"           "comment"                       nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "comms"          "comments"                      nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
...
(define-abbrev global-abbrev-table "twt"            "those were the"                nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "oom"            "one or more"                   nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "wnht"           "would not have to"             nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "wdnt"           "would not"                     nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "itmes"          "items"                         nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "ocntrol"        "control"                       nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "thoro"          "thorough"                      nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "itt"            "I thought that"                nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "prio"           "priority"                      nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "genda"          "agenda"                        nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "bottomost"      "bottommost"                    nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "behav"          "behavior"                      nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "thnk"           "think"                         nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "digesteable"    "digestible"                    nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "subtaks"        "subtasks"                      nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "themselvs"      "themselves"                    nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "tasts"          "tasks"                         nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "todos"          "TODOs"                         nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "todo"           "TODO"                          nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "gs"             "generally speaking"            nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
...
(define-abbrev global-abbrev-table "woth"           "worth"                         nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "hasnt"          "has not"                       nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "arbil"          "arbitrarily"                   nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "vari"           "various"                       nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "keywrods"       "keywords"                      nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "acountable"     "accountable"                   nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "propspect"      "prospect"                      nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "aagm"           "at any given moment"           nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "odl"            "old"                           nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "headliens"      "headlines"                     nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "props"          "properties"                    nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "headli"         "headline"                      nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "hli"            "headline"                      nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "fnd"            "find"                          nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "diffi"          "difficult"                     nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "thigs"          "things"                        nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "idds"           "IDs"                           nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "someting"       "something"                     nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
...
(define-abbrev global-abbrev-table "req"            "require"                       nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "reqm"           "requirement"                   nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
...
(define-abbrev global-abbrev-table "imml"           "immediately"                   nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "imm"            "immediate"                     nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
...
(define-abbrev global-abbrev-table "idnwt"          "I do not want to"              nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
...
(define-abbrev global-abbrev-table "dif"            "different"                     nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
(define-abbrev global-abbrev-table "diff"           "different"                     nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
...
(define-abbrev global-abbrev-table "iis"            "it is"                         nil :enable-function #'+abbrev-enable-plain-text-abbrevs-p)
