...
;; I am inclined to use denote because of a falling out with my org
...
;; into taking notes with just plain text, instead augmenting the files with
;; packages like hyperbole and outshine.
