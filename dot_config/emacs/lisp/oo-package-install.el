;;; oo-install.el --- Package Installation -*- lexical-binding: t; -*-
;;
...
(defun oo-package-install (recipe)
  (for! ((&as recipe (name . spec)) package-vc-selected-packages)
    ...
    (flet! package-vc--unpack-1 (fn desc dir)
