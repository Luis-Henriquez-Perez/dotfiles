...
(cl-pushnew 'dumb-jump package-selected-packages)
...
(cl-pushnew 'gumshoe package-selected-packages)
...
(cl-pushnew 'tok-theme package-selected-packages)
...
(dolist (package package-selected-packages)
  (unless (package-installed-p package)
    (cond ((assq package package-archive-contents)
           ...
           (unless (package-installed-p package)
             (message "Successfully installed package `%s'")
