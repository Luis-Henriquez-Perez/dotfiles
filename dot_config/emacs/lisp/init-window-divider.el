;;; init-window-divider.el --- initialize window-divider -*- lexical-binding: t; -*-
;;
...
;;; provide
(provide 'init-window-divider)
;;; init-window-divider.el ends here
