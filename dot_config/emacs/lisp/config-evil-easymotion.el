;;; oo-after-load-evil-easymotion.el --- evil-easymotion configuration -*- lexical-binding: t; -*-
;;
...
This is a wrapper around `evilem-make-motion'."
  ...
  `(evilem-make-motion ,name (lambda ,args ,docstring (interactive) (progn! ,@body)) ,@map))
;;;; beginning of word
