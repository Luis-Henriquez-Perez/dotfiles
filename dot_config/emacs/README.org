...
* Naming Convention
I prefix internal functions with =oo=.  But if I feel a function is an extension
for another feature then I make the extension =+FEATURE=.  I took this idea from
doom and the reasoning--for me at least, I do not know for doom--is that this
name is concise and it connotes that it is an extension for said feature.  It
greatly reduces the amount of functions prefixed with =oo=.
* why the name =OO=?
:PROPERTIES:
